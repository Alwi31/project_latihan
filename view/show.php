                        ...
                        <div class="right-element">
                            ...
                            <div class="user-profile-container">
                                ...
                                <div class="menu-item user-menu">
                                    <a href="#user-menu" class="nav-link"><i class="icon icon-user"></i></a>
                                    <ul class="dropdown-content">
                                        <li><a href="dashboard_user.php" class="icon icon-user"> Dashboard</a></li>
                                        <li><a href="../controller/AuthController.php?action=logout" class="icon icon-sign-out"> 🚪 Logout</a></li>
                                </div>
                            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="main-slider pattern-overlay">
                        ...
                        <div class="slider-item">
                            <div class="banner-content">
                                <h2 class="banner-title">Dilan 1990</h2>
